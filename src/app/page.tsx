...
export default function Home() {
  ...
  // LocalBusiness Structured Data for Local SEO (Córdoba)
  const jsonLd = {
  ...
  return (
    <main className="flex min-h-[200vh] flex-col overflow-hidden bg-background text-foreground bg-mesh">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-10 flex flex-col items-center text-center gap-12">
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="flex flex-col items-center max-w-5xl">
            <motion.div variants={fadeIn} className="inline-flex items-center gap-3 mb-8 px-5 py-2 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-md shadow-[0_0_15px_rgba(195,216,9,0.2)]">
              ...
              <span className="text-xs font-bold text-primary tracking-widest uppercase">Agencia Web & IA en Córdoba, ARG</span>
            </motion.div>
      ...
      <section className="w-full py-16 md:py-20 px-4 md:px-10 border-t border-white/5">
        <div className="max-w-6xl mx-auto bg-primary text-black rounded-[2rem] sm:rounded-[3rem] p-7 sm:p-10 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
           ...
           <div className="md:w-1/2 relative z-10">
             <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-6 leading-tight">No vendemos webs. Construimos <span className="italic">sistemas.</span></h2>
             <p className="text-black/80 font-medium text-lg leading-relaxed mb-8">
               La mayoría de agencias crean plantillas estáticas y te dejan a la deriva. Desde Córdoba al mundo, nosotros integramos Identidad Web de clase mundial con Cerebros de Inteligencia Artificial. Tu marca no solo será bella: será <strong>inteligentemente letal.</strong>
             </p>
      ...
      <section className="w-full py-32 px-4 relative overflow-hidden flex flex-col items-center justify-center border-t border-white/5 mt-auto">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-7xl font-black text-center text-white mb-6 relative z-10 tracking-tighter">
